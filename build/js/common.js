(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('secretjs')) :
	typeof define === 'function' && define.amd ? define('common', ['secretjs'], factory) :
	(global = global || self, factory(global.secretjs));
}(this, (function (secretjs) { 'use strict';
	  ...
	  btnDelegate.forEach(btn => {
	    btn.addEventListener("click", async () => {
	      ...
	      if (classList.contains("js-secret")) {
	        ...
	        console.log(secretjs.CosmWasmClient);
	        console.log(offlineSigner);
	        const accounts = await offlineSigner.getAccounts(); //const addresses = accounts.map((acct) => acct.address);
